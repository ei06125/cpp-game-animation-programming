...
Transform mix(const Transform &a, const Transform &b, float t) {
  ...
  return Transform(lerp(a.position, b.position, t), nlerp(a.rotation, bRot, t),
...
Transform mat4ToTransform(const mat4 &m) {
  ...
  mat4 rotScaleMat(m.v[0], m.v[1], m.v[2], 0, m.v[4], m.v[5], m.v[6], 0, m.v[8],
                   m.v[9], m.v[10], 0, 0, 0, 0, 1);
