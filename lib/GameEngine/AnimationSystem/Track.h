...
template <typename T, int N> class Track {
  protected:
  ...
  protected:
	...
	T Hermite(float time, const T &point1, const T &slope1, const T &point2,
			  const T &slope2);
...
template <typename T, int N> class FastTrack : public Track<T, N> {
  protected:
