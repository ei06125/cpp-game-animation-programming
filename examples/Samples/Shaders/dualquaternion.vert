...
// skinning uniforms (mat2x4 instead of mat4)
// > mat2x4[0] is the real part
// > mat2x4[1] is the dual part
...
void main() {
    ...
    // Skin the vertex and process model-view-project pipeline
...
// Scaling should NOT be supported with dual quaternions. It's not worth it.